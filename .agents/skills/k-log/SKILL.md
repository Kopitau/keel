...
An upstream review is read-only: date, upstream URL, old/new version or commit, diff, one conclusion (unchanged / watch / recommend research / recommend change). An authorized update proceeds within scope; version frozen semantics through CHG when affected. Do not treat a read-only upstream review as update authorization.
